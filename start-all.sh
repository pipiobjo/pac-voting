...
java -Xmx256m -Xss16m -jar support-monitor*.jar >> logs/support-monitor.log & echo $! > pids/support-monitor.pid
...
java -Xmx128m -Xss16m -jar -Dspring.profiles.active=$STAGE_PROFILE composite-service-*.jar >> logs/composite.log & echo $! > pids/composite.pid
